...
const Emergency = () => {
  // Left Section - Emergency Request Form
  ...
  // Right Section - Donor Filter & List
  ...
  // Function to initiate a call via backend API
  const handleCall = async (phoneNumber) => {
    try {
      // Format phone number: if already starts with +, use as is; else prepend +91 (India code)
